...
class VisDA2017ClassificationFull(BaseDataset):
    ...
    def __init__(self, root: str, domain: str, transform):
        ...
        check_length(
            self, {"train": 152397, "validation": 55388, "test": 72372}[domain]
        )
...
class VisDA2017Classification(BaseDownloadableDataset):
    ...
    def set_paths_and_labels(self, root):
        ...
        labels_file = os.path.join(
            root, "VisDA2017", "classification", self.domain, f"{split}.txt"
        )
        ...
        check_length(
            self,
            {
                ...
                "train": {"train": 5000, "val": 5000, "trainval": 10000, "test": 5000}[
                    split
                ],
                "validation": {
                    "train": 5000,
                ...
                "test": {"train": 5000, "val": 5000, "trainval": 10000, "test": 5000}[
                    split
                ],
            }[self.domain],
        )
