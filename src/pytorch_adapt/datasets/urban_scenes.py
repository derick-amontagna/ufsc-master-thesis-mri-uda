    ...
    def __init__(
        ...
        **kwargs
        ...
        if self.domain == "synthia":
            split = {"trainval": "train", "test": "val"}[
                split
            ]  # undoing the definintions in get_three_split_datasets (getters.py)
        ...
        check_length(
            self.dataset,
            {
                "synthia": {"train": 9300, "val": 100, "trainval": None, "test": None}[
                    self.split
                ],
                "cityscapes": {
                    "train": 2475,
    ...
    def __init__(
        ...
        **kwargs
        ...
        check_length(
            self.dataset,
            {
                "gta5": {"train": 23966, "val": 508, "trainval": 24474, "test": None}[
                    self.split
                ],
                "cityscapes": {
                    "train": 2475,
