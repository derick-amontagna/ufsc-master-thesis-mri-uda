...
class MNISTMS:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        data = pkl.load(
            open(os.path.join(root, "mnist_m_s", f"{self.domain}.pkl"), "rb")
        )
        lengths = {
            "train": 1000,
            "val": 1000,
        ...
        check_length(
            self,
            {
                "mnist": {"train": 1000, "val": 1000, "trainval": 2000, "test": 1000}[
                    self.split
                ],
                "mnistm": {"train": 1000, "val": 1000, "trainval": 2000, "test": 1000}[
                    self.split
                ],
